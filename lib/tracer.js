...
const buildWaterfallTracer = require('./waterfall_tracer');
...
const Tags = Object.assign({
  ...
  HTTP_PATH: 'http.path',
  WORKER_QUEUE: constants.TAG_WORKER_QUEUE,
  WORKER_STRATEGY: constants.TAG_WORKER_STRATEGY,
  WORKER_REQUEUE: constants.TAG_WORKER_REQUEUE
}, tracing.Tags);
...
module.exports = function Tracer(agent, pkg, env, params) {
  ...
  obj.helpers = {
    ...
    waterfallTracer: buildWaterfallTracer(obj, logger)
  };
